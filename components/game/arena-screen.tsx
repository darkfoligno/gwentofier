...
export function ArenaScreen() {
  ...
  const { matchState, boardCards, matchActions, pendingAttack, pendingEffectChoice, connectionStatus, isTraining, isCurrentPlayer, isPlayer1, opponentId, hasActedThisTurn, reactionUsed,usedEffectCardIds } = duel
  ...
  useEffect(()=>{
    if(!isTraining||!matchState||matchState.status!=="in_progress"||isCurrentPlayer)return
